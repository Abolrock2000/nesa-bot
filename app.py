...
body{
    ...
    background:
    radial-gradient(circle at top,#432020,#120909 45%,#050505);
}
...
.gift{
    ...
    background:
    linear-gradient(135deg,#ff1744,#c51162);

    border-radius:8px;

    box-shadow:
    0 15px 40px rgba(255,0,70,.4);
}
...
.lid{
    ...
    background:
    linear-gradient(135deg,#ff4081,#d50000);
