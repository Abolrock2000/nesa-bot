...
# مسیر عکس
PHOTO_PATH = "/storage/emulated/0/Pictures/file_0000000 0f1788210bc5e8dqq3e16a277.png"
...
# ============================================================
# ⌨️ منوی اصلی (دکمه ارسال عکس فقط برای مالک)
# ============================================================
...
def get_main_keyboard(chat_id=None):
    ...
    if chat_id == YOUR_CHAT_ID:
        ...
        keyboard.append(["🖼️ ارسال عکس"])  # فقط برای شما
...
# ============================================================
# 🖼️ منوی ارسال عکس (فقط برای مالک)
# ============================================================
    ...
    if text == "🧪 ارسال عکس به تست":
        if chat_id == YOUR_CHAT_ID:
            ...
            if success:
                ...
                send_message(chat_id, "❌ ارسال عکس ناموفق بود! مسیر عکس رو چک کن!")
                send_message(chat_id, f"📂 مسیر عکس: {PHOTO_PATH}")
        else:
            send_message(chat_id, "❌ این بخش فقط برای صاحب ربات dostęp است.", get_main_keyboard(chat_id))
        return
