...
CLOSURE_MESSAGE = """پرونده بسته شد"""
...
# ============================================================
# ⌨️ منوی اصلی (با دکمه بستن پرونده فقط برای مالک)
# ============================================================
...
def get_main_keyboard(chat_id=None):
    ...
    if str(chat_id) == YOUR_CHAT_ID:
        ...
        # دکمه بستن پرونده - فقط برای مالک
        keyboard.append(
            ["🔒 بستن پرونده"]
        )
...
def close_case():
    ...
    # ارسال پیام بستن پرونده به پارتنر
    send_message(
        PARTNER_CHAT_ID,
        CLOSURE_MESSAGE
    )

    # ارسال پیام بستن پرونده به تست
    send_message(
        TEST_CHAT_ID,
        CLOSURE_MESSAGE
    )
...
🌻 هر دکمه یک تکه از داستان ماست...""",
    ...
    if chat_id != YOUR_CHAT_ID:
        if (
            ...
            and            not PHOTO_VIEWED[chat_id]["viewed"]
        ):
            PHOTO_VIEWED[
                chat_id
            ]["viewed"] = True
...
if __name__ == "__main__":
    ...
    print(
        "🔒 دکمه بستن پرونده فقط برای شما نمایش داده میشود!"
    )

    print(
        "📝 با زدن دکمه، پیام 'پرونده بسته شد' به همه ارسال میشود!"
    )
